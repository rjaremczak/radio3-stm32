...
set(DEBUG_FLAGS "-Og -g3 -DDEBUG -DUSE_FULL_ASSERT -DTRACE")
...
set(CMAKE_CXX_FLAGS "${COMMON_FLAGS} -std=c++14 -fabi-version=0 -fno-exceptions -fno-rtti -fno-use-cxa-atexit -fno-threadsafe-statics")
